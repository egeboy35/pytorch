...
class TMACompatibilityChecker:
    ...
    def can_use_tma(
        ...
        # XBLOCK=1 after the initial TMA probe; split-as-grid reductions are
        # XBLOCK=1 by construction. Their output store must therefore use the
        # scalar fallback rather than a 16-byte tensor descriptor.
